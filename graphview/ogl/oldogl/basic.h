...
// Modified by:
// Created:     12/07/98
// RCS-ID:      $Id: basic.h,v 1.2 2002/01/22 09:03:53 dildog Exp $
...
public:
	...
	virtual void OnTranslate(double xoff, double yoff);
...
public:
	...
	*/
	...
	virtual inline int GetNumberOfTextRegions() const { return (int) m_regions.GetCount(); }
