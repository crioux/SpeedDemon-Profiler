...
void wxCompositeShape::ReadConstraints(wxExpr *clause, wxExprDatabase *database)
{
  ...
  while (haveConstraints)
  {
    ...
    if (objExpr1 && objExpr1->GetClientData())
      ...
      SAF_ASSERT(0); //("Couldn't find constraining image of composite.", "Object graphics error");
    ...
    while (currentIdExpr)
    {
      ...
      {
        SAF_ASSERT(0);//wxError("Couldn't find constrained image of composite.", "Object graphics error");
      }
