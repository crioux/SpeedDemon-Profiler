...
// Modified by:
// Created:     12/07/98
// RCS-ID:      $Id: ogldiag.h,v 1.2 2002/01/22 09:03:53 dildog Exp $
...
public:
	...
	inline size_t GetCount() const { return m_shapeList->GetCount(); }
	...
	void GetDiagramExtents(double &minx, double &miny, double &maxx, double &maxy);
	void TranslateAllShapes(double offx, double offy);
/*
#ifdef PROLOGIO
	bool SerializeToDatabase(wxExprDatabase *database);
	bool SerializeFromDatabase(wxExprDatabase *database);
