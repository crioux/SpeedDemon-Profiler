...
// Modified by:
// Created:     12/07/98
// RCS-ID:      $Id: drawn.h,v 1.7 2004/06/09 16:42:21 ABX Exp $
...
public:
  ...
  wxPen*            m_outlinePen;
  wxBrush*          m_fillBrush;
  std::list<int>	m_outlineColours; // List of the GDI operations that comprise the outline
  std::list<int> m_fillColours; // List of the GDI operations that fill the shape
