...
//      case META_STRETCHBLT:
      case META_POLYGON:
      {
        ...
        for (int i = 0; i < (int)rec->param1; i++)
        {
      ...
      case META_POLYLINE:
      {
        ...
        rec->param1 = (size_t)getshort(handle);
        rec->points = new wxRealPoint[(int)rec->param1];
        for (int i = 0; i < (int)rec->param1; i++)
        {
          rec->points[i].x = getshort(handle);
...
//      case META_SELECTCLIPREGION: // DO THIS!
      case META_SELECTOBJECT:
      {
        ...
        rec->param1 = (size_t)getshort(handle); // Position of object in gdiObjects list
        metaRecords.Append(rec);
...
//      case META_DIBSTRETCHBLT:
      case META_DIBCREATEPATTERNBRUSH:
      {
        ...
        rec->param2 = (size_t)(gdiObjects.GetCount() - 1);
        break;
      }
...
//      case META_ENDDOC:
      ...
      case META_CREATEPENINDIRECT:
      {
        ...
        rec->param1 = (size_t)wxThePenList->FindOrCreatePen(colour, x, style);
        metaRecords.Append(rec);
        gdiObjects.Append(rec);
      ...
      case META_CREATEBRUSHINDIRECT:
      {
        ...
        wxColour colour(GetRValue(colorref), GetGValue(colorref), GetBValue(colorref));
        rec->param1 = (size_t)wxTheBrushList->FindOrCreateBrush(colour, style);
        metaRecords.Append(rec);
        gdiObjects.Append(rec);
        AddMetaRecordHandle(rec);
        rec->param2 = (size_t)(gdiObjects.GetCount() - 1);
...
//      case META_SCALEVIEWPORTEXT:
      case META_LINETO:
      {
        wxCoord x1 = (long)rec->param1;
        wxCoord y1 = (long)rec->param2;
        dc->DrawLine((wxCoord) lastX, (wxCoord) lastY, x1, y1);
        break;
      }
      case META_MOVETO:
      {
...
//      case META_PIE: // DO!!!
      case META_RECTANGLE:
      {
        dc->DrawRectangle((wxCoord)rec->param1, (wxCoord)rec->param2,
                          (wxCoord)(rec->param3 - rec->param1),
                          (wxCoord)(rec->param4 - rec->param2));
        break;
      }
      case META_ROUNDRECT:
      {
        dc->DrawRoundedRectangle((wxCoord)rec->param1, (wxCoord)rec->param2,
                          (wxCoord)(rec->param3 - rec->param1),
                          (wxCoord)(rec->param4 - rec->param2),
                          (wxCoord)rec->param5);
        break;
...
/*
        ...
        wxColour colour(GetRValue(colorref), GetGValue(colorref), GetBValue(colorref));
        rec->param1 = (size_t)wxTheBrushList->FindOrCreateBrush(&colour, wxSOLID);
*/
        break;
      }
      case META_CREATEBITMAPINDIRECT:
