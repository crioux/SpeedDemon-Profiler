================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : sdtest_ppc1 Project Overview
===============================================================================

The application wizard has created this sdtest_ppc1 application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your sdtest_ppc1 application.
...
sdtest_ppc1.h
    ...
    project specific headers and declares the Csdtest_ppc1App application class.

sdtest_ppc1.cpp
    This is the main application source file that contains the application
    class Csdtest_ppc1App.
...
sdtest_ppc1Doc.h, sdtest_ppc1Doc.cpp - the document
    These files contain your Csdtest_ppc1Doc class.  Edit these files to
    add your special document data and to implement file saving and loading
    (via Csdtest_ppc1Doc::Serialize).

sdtest_ppc1View.h, sdtest_ppc1View.cpp - the view of the document
    These files contain your Csdtest_ppc1View class.
    Csdtest_ppc1View objects are used to view Csdtest_ppc1Doc objects.
...
StdAfx.h, StdAfx.cpp
    ...
    named sdtest_ppc1.pch and a precompiled types file named StdAfx.obj.
