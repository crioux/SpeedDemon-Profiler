...
/// Disable dragging of tabs
#define wxFNB_CTRL_BACKGROUND			256
...
class WXGCEXPORT wxFlatNotebook : public wxPanel
{
private:
...
* \brief Notebook page
*/
class WXGCEXPORT wxPageContainer : public wxControl
{
...
*/
class WXGCEXPORT wxFlatNotebookEvent : public wxNotifyEvent 
{
